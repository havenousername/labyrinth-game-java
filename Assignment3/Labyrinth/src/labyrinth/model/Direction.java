...
public enum Direction {
    DOWN(DirectionBound.UPPER_BOUND, DirectionBound.CURRENT_BOUND), 
    LEFT(DirectionBound.CURRENT_BOUND, DirectionBound.LOWER_BOUND),
    UP(DirectionBound.LOWER_BOUND, DirectionBound.CURRENT_BOUND),
    RIGHT(DirectionBound.CURRENT_BOUND, DirectionBound.UPPER_BOUND);
